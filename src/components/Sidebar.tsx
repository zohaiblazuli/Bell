...
const AUTHOR_URL = 'https://github.com/zohaiblazuli';

/** The GitHub mark (Octocat silhouette), one ink so it follows the tone. */
function GithubMark() {
  return (
    ...
    <aside className="sk-side">
      ...
      <div className="sk-side__foot">
        ...
        <div className="sk-side__version">
          ...
          <button
            type="button"
            className="sk-side__author"
            title="zohaiblazuli on GitHub"
